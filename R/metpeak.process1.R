.metpeak.process1 <- function(IP,INPUT,batch_id,minimal_counts_in_fdr=10){
#   using constrained newton's method written in R to call peaks per gene
  print("Peak Calling Stage! R")
  Ng = unique(batch_id)
  nip <- ncol(IP)
  nin <- ncol(INPUT)
