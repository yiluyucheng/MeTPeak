.peak.call.module2 <- function(READS_COUNT,SAMPLE_ID,PARAMETERS,ANNOTATION){
  
  
  PW = .metpeak.process2(as.matrix(READS_COUNT[,SAMPLE_ID$ip]),as.matrix(READS_COUNT[,SAMPLE_ID$input]),READS_COUNT$batch_id) 
